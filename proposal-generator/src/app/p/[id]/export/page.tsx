...
function buildDefaultSections(inputs: ProposalInputs): ExportSection[] {
  ...
  // Average annual investment across the contract
  ...
  finalElements.push(el('page-footer', 12, { date: today, showConfidential: true, customerLogoSrc: inputs.company.customerLogoBase64 }));
  ...
  return (
    <LayoutModeContext.Provider value={{ layoutMode, setLayoutMode }}>
      <ExportToolbar
        proposalId={id}
        inputs={proposalData}
        onClose={() => router.push(`/p/${id}/inputs`)}
      />
