  ...
  return (
    <section id="security" className="py-20 sm:py-28 bg-[#f3f4f6]" ref={sectionRef}>
      <div className="max-w-5xl mx-auto px-6 ms-fade-up">
        <h2 className="text-3xl sm:text-4xl font-bold text-[#03143B] mb-2">Security & Integration</h2>
        <div className="w-16 h-0.5 bg-[#03143B] mb-10" />

        {/* Security features */}
        <div ref={secRef} className="mb-12 ms-fade-up">
          <h3 className="text-lg font-semibold text-[#03143B] mb-5">Enterprise Security</h3>
        ...
        <div ref={intRef} className="mb-12 ms-fade-up">
          <h3 className="text-lg font-semibold text-[#03143B] mb-5">Your Integration Landscape</h3>
        ...
        <div ref={timeRef} className="ms-fade-up">
          <h3 className="text-lg font-semibold text-[#03143B] mb-5">Implementation Timeline (12 weeks)</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 ms-stagger">
            {IMPLEMENTATION_TIMELINE.map((phase) => (
              <div
                key={phase.week}
                className="p-5 bg-white rounded-lg border-t-4 border-[#03143B]"
              >
                <div className="text-xs font-semibold text-[#03143B] mb-1">{phase.week}</div>
                <h4 className="font-bold text-[#03143B] text-sm mb-1">{phase.title}</h4>
